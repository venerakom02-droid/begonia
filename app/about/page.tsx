...
export const metadata: Metadata = {
  title: "О нас — BegoNia | Коллекция декоративнолиственных бегоний",
  description:
    "История коллекции BegoNia: 7+ лет опыта, 180+ сортов, 2400+ отправок. Узнайте о нашей страсти к редким бегониям и философии бережного ухода.",
};
...
const TIMELINE = [
  ...
  { year: "2026", text: "Запуск BegoNia — онлайн-магазин коллекции" },
];
