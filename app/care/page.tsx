...
export const metadata: Metadata = {
  title: "Уход за бегониями — полное руководство",
  description:
    "Подробное руководство по уходу за декоративнолиственными бегониями: освещение, полив, температура, влажность, грунт, пересадка, болезни и вредители. Советы от коллекционера.",
};
