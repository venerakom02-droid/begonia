...
export const products: Product[] = [
  ...
  },
  {
    ...
    slug: 'hn-vulkan',
    nameRu: 'ХН Вулкан',
    nameLatin: "Begonia rex 'HN Vulkan'",
    series: 'ХН',
    type: 'rex',
    format: 'baby',
    price: 300,
    ...
    terrarium: false,
    mini: false,
    images: ['/hn-vulkan-1.png'],
    description:
      'Крупнолистный рекс серии ХН с фактурными резными листьями: тёмно-винная кайма, малиновая звезда в центре и серебристо-зелёный точечный рисунок по полю листа. Сорт выглядит очень эффектно за счёт контраста и волнистого края.',
    careInstructions:
      'Любит яркий рассеянный свет и стабильную влажность 55–70%. Полив умеренный, без застоя воды. Грунт рыхлый, на основе торфа и перлита.',
    bonusPoints: 50,
  },
