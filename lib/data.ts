/* ──────────────────────────────────────────────
 * BegoNia — Mock data & TypeScript types
 * ────────────────────────────────────────────── */
...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    text: 'Заказываю в BegoNia уже третий раз. Качество растений неизменно высокое, а редкие сорта просто невозможно найти где-то ещё. Бревиримоза приехала шикарная — ни одного повреждения.',
    product: 'Бревиримоза',
    rating: 5,
  },
  {
